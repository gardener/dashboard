...
const factory = originalRequire => {
  ...
  registry.set('./dependenciesUtils', createModule($b9cb2f40602d27575e54993d136432d9))
  registry.set('@larry1123/yarn-utils', createModule($31c91b8668408072d26c360e8a28a172))
  registry.set('../util', createModule($975d0c818d99b2dc5585573c74df71ff))
  registry.set('../ProductionInstallFetcher', createModule($7d3ca10619a5072206d5cdaf2b4891f7))
  registry.set('../ProductionInstallResolver', createModule($21b96eaf43130d3dd76329489e7cca5d))
  registry.set('./ProductionInstallCommand', createModule($615abc4097bb853456dfd228f0f8bd09))
...
/**
 * Wrapper function for the `dependenciesUtils` implementation from the
 ...
 */
const $b9cb2f40602d27575e54993d136432d9 = (require, exports) => {
  "use strict";
  /*
...
/**
 * Wrapper function for the `yarn-utils` implementation from the
 * Yarn plugin by Larry1123. The original source code remains unmodified and can be found here:
 * https://gitlab.com/Larry1123/yarn-contrib/-/blob/master/packages/yarn-utils/lib/index.js
 */
const $31c91b8668408072d26c360e8a28a172 = (require, exports) => {
  "use strict";
  /*
   * Copyright 2020 Larry1123
   *
  ...
  const dependenciesUtils = require("./dependenciesUtils");
  exports.dependenciesUtils = dependenciesUtils;
}

/**
 * Wrapper function for the `util` implementation from the
 * Yarn plugin by Larry1123. The original source code remains unmodified and can be found here:
 * https://gitlab.com/Larry1123/yarn-contrib/-/blob/master/packages/plugin-production-install/lib/util.js
 */
const $975d0c818d99b2dc5585573c74df71ff = (require, exports) => {
  "use strict";
  /*
   * Copyright 2020 Larry1123
   *
...
/**
 * Wrapper function for the `ProductionInstallFetcher` implementation from the
 * Yarn plugin by Larry1123. The original source code remains unmodified and can be found here:
 * https://gitlab.com/Larry1123/yarn-contrib/-/blob/master/packages/plugin-production-install/lib/ProductionInstallFetcher.js
 */
const $7d3ca10619a5072206d5cdaf2b4891f7 = (require, exports) => {
  "use strict";
  /*
   * Copyright 2020 Larry1123
   *
...
/**
 * Wrapper function for the `ProductionInstallResolver` implementation from the
 * Yarn plugin by Larry1123. The original source code remains unmodified and can be found here:
 * https://gitlab.com/Larry1123/yarn-contrib/-/blob/master/packages/plugin-production-install/lib/ProductionInstallResolver.js
 */
const $21b96eaf43130d3dd76329489e7cca5d = (require, exports) => {
  "use strict";
  /*
   * Copyright 2020 Larry1123
   *
...
/**
 * Wrapper function for the `productionInstall` implementation from the
 * Yarn plugin by Larry1123. The original source code remains unmodified and can be found here:
 * https://gitlab.com/Larry1123/yarn-contrib/-/blob/master/packages/plugin-production-install/lib/commands/productionInstall.js
 */
const $615abc4097bb853456dfd228f0f8bd09 = (require, exports) => {
  "use strict";
  /*
   * Copyright 2020 Larry1123
   *
          ...
          const report = await core_1.StreamReport.start({
              ...
              await report.startTimerPromise('Installing production version', async () => {
                  ...
                  const multiResolver = new MultiResolver_1.MultiResolver([
                      new core_2.LockfileResolver(realResolver),
                      realResolver,
                  ]);
