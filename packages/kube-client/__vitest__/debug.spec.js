...
-----END CERTIFICATE-----`,
    ...
    beforeEach(() => {
      isDisabledStub = vi.spyOn(logger, 'isDisabled').mockReturnValue(false)
      requestStub = vi.spyOn(logger, 'request').mockImplementation(() => {})
      responseStub = vi.spyOn(logger, 'response').mockImplementation(() => {})
    })
