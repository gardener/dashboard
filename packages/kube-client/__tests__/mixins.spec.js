  ...
  describe('mixins', () => {
    ...
    describe('Version', () => {
      ...
      it('should check that Version mixins do not occur in the inheritance hierarchy', () => {
        expect(new V1Object().constructor.version).toBe('v1')
        expect(() => new V1Object() instanceof V1).toThrow(TypeError)
        expect(new V1Alpha1Object().constructor.version).toBe('v1alpha1')
        expect(() => new V1Alpha1Object() instanceof V1Alpha1).toThrow(TypeError)
        expect(new V1Beta1Object().constructor.version).toBe('v1beta1')
    ...
    describe('ClusterScoped', () => {
      ...
      it('should check that declared mixins do occur in the inheritance hierarchy', () => {
        ...
        expect(testObject.constructor.scope).toBe('Cluster')
      ...
      describe('Readable', () => {
        ...
        it('should enrich listed items with apiVersion and kind', async () => {
          ...
          const testObject = new TestObject()
          testObject[http.request] = vi.fn(() => body)
    ...
    describe('NamespaceScoped', () => {
      ...
      it('should check that declared mixins do occur in the inheritance hierarchy', () => {
        const testObject = new TestObject()
        expect(testObject.constructor.scope).toBe('Namespaced')
      ...
      describe('Observable', () => {
        ...
        it('should create an informer across all namespaces', () => {
          const testObject = new TestObject()
          testObject.listAllNamespaces = vi.fn()
          testObject.watchListAllNamespaces = vi.fn()
