...
async function resourceEndpoints () {
  ...
  for (const name of Object.keys(groups)) {
    const { default: pkg } = await import(`../lib/resources/${name}.js`)
...
describe('kube-client', () => {
  describe('#createClient', () => {
    ...
    beforeEach(() => {
      ...
      getSecretStub = vi.spyOn(testClient.core.secrets, 'get')
      createShootAdminKubeconfigStub = vi.spyOn(testClient['core.gardener.cloud'].shoots, 'createAdminKubeconfigRequest')
    })
