...
describe('logger', function () {
  ...
  it('should log a trace message', function () {
    ...
    expect(logger.console.args).toEqual(['D T ' + chalk.cyan('trace') + ': ' + msg, ...args])
  })

  it('should log a debug message', function () {
    const logger = createNoisyLogger()
    logger.debug(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.blue('debug') + ': ' + msg, ...args])
  })

  it('should log a log message', function () {
    const logger = createNoisyLogger()
    logger.log(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.whiteBright('log') + '  : ' + msg, ...args])
  })

  it('should log an info message', function () {
    const logger = createNoisyLogger()
    logger.info(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.green('info') + ' : ' + msg, ...args])
  })

  it('should log a warn message', function () {
    const logger = createNoisyLogger()
    logger.warn(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.yellow('warn') + ' : ' + msg, ...args])
  })

  it('should log an error message', function () {
    const logger = createNoisyLogger()
    logger.error(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.red('error') + ': ' + msg, ...args])
  })

  it('should log a http message', function () {
    const logger = createNoisyLogger()
    logger.http(msg, ...args)
    expect(logger.console.args).toEqual(['D T ' + chalk.magenta('http') + ' : ' + msg, ...args])
  })
  ...
  it('should log a request message', function () {
    ...
    expect(logger.console.args).toEqual(['D T ' + chalk.black.bgGreen('req') + '  : ' + msg])
  })
  ...
  it('should log a response message', function () {
    ...
    expect(logger.console.args).toEqual(['D T ' + chalk.black.bgBlue('res') + '  : ' + msg])
  })
})
