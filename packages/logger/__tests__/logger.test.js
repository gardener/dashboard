...
describe('logger', function () {
  ...
  it('should get the current timestamp', function () {
  ...
  it('should get the user identity', function () {
  ...
  it('should log a http message via stream', function () {
    const logger = createNoisyLogger()
  ...
  it('should log a connect message', function () {
    const logger = createNoisyLogger()
