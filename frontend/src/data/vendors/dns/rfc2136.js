  ...
  secret: {
    ...
    fields: [
      ...
      },
      {
        ...
        values: [
          {
            title: 'Provider default (HMAC-SHA256)',
            value: '',
          },
          {
            title: 'HMAC-SHA256',
    ...
    help: `
      <p>
        This DNS provider allows you to create and manage DNS entries for authoritative DNS servers supporting dynamic updates with DNS messages following
        <a href="https://datatracker.ietf.org/doc/html/rfc2136">RFC2136</a>
        (DNS Update) like knot-dns or others.
      </p>
      <p>
        The configuration depends on the DNS server product. You need permissions for <code>update</code> and <code>transfer</code> (AXFR) actions on your zones and a TSIG secret.
      </p>
      <p>
        For details see
