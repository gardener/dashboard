  ...
  <v-tooltip top v-if="staleSinceTimestamp">
    <template v-slot:activator="{ on }">
     ...
     <span v-if="staleAutoDeleteTimestamp">
      This is a <span class="font-weight-bold">stale</span> project. Gardener will auto delete this project <span class="font-weight-bold"><time-string :date-time="staleAutoDeleteTimestamp" :pointInTime="1"></time-string></span>
    </span>
    <span v-else>
