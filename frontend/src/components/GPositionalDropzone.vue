...
<template>
  <svg
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <path @dropped="dropped" @drag-over="dragOver" class="g-droppable" d="M282.5,117.5 L282.5,517.5 L117.5,352.5 L122.5,352.5 L122.499,277.501 L282.5,117.5 Z" id="bottom" :data-g-id="uuid" fill-opacity="0" fill="#D8D8D8" transform="translate(200.000000, 317.500000) rotate(90.000000) translate(-200.000000, -317.500000) "></path>
      <path @dropped="dropped" @drag-over="dragOver" class="g-droppable" d="M400,0 L400,400 L240,240 L240,165 L235.001,164.999 L400,0 Z" id="right" :data-g-id="uuid" fill-opacity="0" fill="#D8D8D8"></path>
      <path @dropped="dropped" @drag-over="dragOver" class="g-droppable" d="M165,2.55795385e-13 L165,400 L2.84217094e-14,234.999 L2.84217094e-14,165.001 L165,2.55795385e-13 Z" id="left" :data-g-id="uuid" fill-opacity="0" fill="#D8D8D8" transform="translate(82.500000, 200.000000) rotate(-180.000000) translate(-82.500000, -200.000000) "></path>
      <path @dropped="dropped" @drag-over="dragOver" class="g-droppable" d="M282.5,-117.5 L282.5,282.5 L117.5,117.5 L117.5,47.5 L282.5,-117.5 Z" id="top" :data-g-id="uuid" fill-opacity="0" fill="#D8D8D8" transform="translate(200.000000, 82.500000) rotate(-90.000000) translate(-200.000000, -82.500000) "></path>
    </g>
  </svg>
</template>
