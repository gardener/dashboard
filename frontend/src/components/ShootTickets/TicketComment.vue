  ...
  <v-list-item>
    ...
    <v-list-item-content class="comment">
      <v-list-item-title class="comment-header toolbar-background toolbar-title--text">
        <a :href="sanitizeUrl(htmlUrl)" target="_blank" rel="noopener" class="toolbar-title--text"><span class="font-weight-bold toolbar-title--text">{{login}}</span> commented <time-string :date-time="createdAt" mode="past" content-class="toolbar-title--text"></time-string></a>
      </v-list-item-title>
