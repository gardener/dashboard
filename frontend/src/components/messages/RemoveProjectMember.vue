...
<template>
  <div>
    <template v-if="namespace && memberName">
      Do you want to remove the service account <em>{{memberName}}</i> of namespace <i>{{namespace}}</em>
      from the project <em>{{projectName}}</em>?
    </template>
    <template v-else-if="memberName">
      Do you want to remove the user <em>{{memberName}}</i> from the project <i>{{projectName}}</em>?
    </template>
    <template v-else>
