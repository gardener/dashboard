...
export default {
  ...
  computed: {
    color1 () {
      return this.iconColorCode || '#252F3E'
    },
    color2 () {
      return this.iconColorCode || '#FF9900'
    }
  }
}
</script>
