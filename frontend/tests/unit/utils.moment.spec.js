  ...
  describe('moment', () => {
    ...
    describe('core', () => {
      it('should format a date', () => {
        expect(dayjs(time).format('YYYY-MM-DD')).toEqual('2021-04-14')
        expect(dayjs(date).format('YYYY-MM-DD')).toEqual('2012-02-17')
      })
    })
    ...
    describe('utc', () => {
      it('should format a utc date', () => {
        expect(dayjs.utc(time).format()).toEqual('2021-04-14T10:21:54Z')
      })
