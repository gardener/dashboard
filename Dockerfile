...
# Fetch and verify dependencies before disabling network for the rest of the build.
RUN YARN_ENABLE_SCRIPTS=0 YARN_ENABLE_HARDENED_MODE=1 yarn install --immutable --check-cache --refresh-lockfile
