...
import { createAgent } from './__tests__/helpers/createAgent.js'
...
vi.mock('@gardener-dashboard/kube-client', async () => {
  return import('./__tests__/mocks/@gardener-dashboard/kube-client.js')
})
...
vi.mock('p-limit', async () => {
  return import('./__tests__/mocks/p-limit.js')
})
...
vi.mock('./lib/config/gardener.js', async (importOriginal) => {
  ...
  const { default: fixtures } = await import('./__tests__/fixtures/index.js')
