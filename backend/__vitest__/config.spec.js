...
import fs from 'fs'
import gardener from '../lib/config/gardener.js'

const { default: originalGardener } = await vi.importActual('../lib/config/gardener.js')
...
describe('config', function () {
  describe('gardener', function () {
    describe('#readConfig', function () {
      ...
      beforeEach(() => {
        readFileSyncStub = vi.spyOn(fs, 'readFileSync').mockReturnValueOnce('port: 1234')
      })
