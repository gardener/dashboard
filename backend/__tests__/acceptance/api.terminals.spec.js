...
describe('api', function () {
  ...
  describe('terminals', function () {
    ...
    beforeEach(function () {
      makeSanitizedHtmlStub = vi.spyOn(converter, 'makeSanitizedHtml').mockImplementation(text => text)
    })
    ...
    describe('garden', function () {
      ...
      describe('as enduser', function () {
        ...
        it('should create a terminal resource', async function () {
          ...
          mockRequest.mockImplementationOnce(fixtures.serviceaccounts.mocks.patch()) // update service account with finalizers/labels/ownerReferences
