...
import * as security from '../../lib/security/index.js'

// Create persistent mock functions for openid-client.
// In ESM the security module's internal `openidClientPromise` / `discoveryPromise`
// variables cannot be reassigned from outside. Instead we mock the `openid-client`
// package itself so the security module receives our spies when it lazy-imports it.
...
vi.mock('openid-client', () => openidClientMocks)
