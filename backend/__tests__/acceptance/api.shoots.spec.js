...
describe('api', function () {
  ...
  describe('shoots', function () {
    ...
    it('should return shoot info', async function () {
      ...
      expect(yamlLoad(res.body.kubeconfigGardenlogin)).toMatchSnapshot('body.kubeconfigGardenlogin')
    })
    ...
    it('should return shoot info without gardenlogin kubeconfig', async function () {
      ...
      expect(infoSpy).toHaveBeenLastCalledWith('failed to get gardenlogin kubeconfig', 'Shoot has no advertised addresses')
    ...
    it('should return a shoot admin kubeconfig', async function () {
      ...
      expect(yamlLoad(res.body.kubeconfig)).toMatchSnapshot('body.kubeconfig')
    })
  })
})
